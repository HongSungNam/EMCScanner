...
public class FrequencySettingsSubPanel extends JPanel {
	...
	public ImageIcon HEADER_DISABLED_BLUE_IMAGE_ICON 		= new ImageIcon("image/PanelBlueFrequency.png");
	...
	public ImageIcon HEADER_DISABLED_DARK_GREEN_IMAGE_ICON = new ImageIcon("image/PanelDarkGreenFrequency.png");
	...
	public FrequencySettingsSubPanel(){
		...
		startFloatInputTextField.setBackground(Program.LIGHT_BLUE_COLOR2);
		    ...
		    public void checkFloat(){
		    	...
		    	try
		    	{
		    		...
		    		if ((0.1 <= value) && (value <= 6000))
			    	{
						...
						{
			    			densityLessThenLabel.setText("<html><font color = rgb(0,0,0)> ≤ " + (int)(endValue - startValue + 1) + "</font></html>");
						}
						else 
					...
					{
						startFloatInputTextField.setBackground(Program.LIGHT_RED_COLOR);
